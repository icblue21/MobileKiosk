...
public class HojupmongFragment4 extends Fragment {
    int resId;
    ImageButton button[];
    Button btn[];
    TextView text[];
    HojupmongFragment4.ButtonList BList[];

    private BusProvider.OntimeListener ontime;

    public HojupmongFragment4() {
        // required
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.fragment_hojupmong4, container, false);
        ...
        BList[0] = new HojupmongFragment4.ButtonList(R.drawable.alcohol1, "연태고량주", 30000);
        BList[1] = new HojupmongFragment4.ButtonList(R.drawable.alcohol2, "공부가주", 20000);
        BList[2] = new HojupmongFragment4.ButtonList(R.drawable.alcohol3, "죽엽청주", 10000);
        BList[3] = new HojupmongFragment4.ButtonList(R.drawable.drink1, "콜라", 1500);
        BList[4] = new HojupmongFragment4.ButtonList(R.drawable.drink2, "사이다", 1500);
    ...
    void SubListenner(int num) {
        switch (num) {
            case 0:
                ...
                ((Order_Hojupmong)getActivity()).setResultView(BList[0].price);
                break;

            case 1:

                ontime.ontimePickerset(BList[1].Fname, BList[1].price);
                ((Order_Hojupmong)getActivity()).setResultView(BList[1].price);
                break;

            case 2:

                ontime.ontimePickerset(BList[2].Fname, BList[2].price);
                ((Order_Hojupmong)getActivity()).setResultView(BList[2].price);
                break;

            case 3:

                ontime.ontimePickerset(BList[3].Fname, BList[3].price);
                ((Order_Hojupmong)getActivity()).setResultView(BList[3].price);
                break;
            case 4:

                ontime.ontimePickerset(BList[4].Fname, BList[4].price);
                ((Order_Hojupmong)getActivity()).setResultView(BList[4].price);
                break;
        }
    }
    ...
    void insertion_sort_price(HojupmongFragment4.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment4.ButtonList key;
    ...
    void insertion_sort_name(HojupmongFragment4.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment4.ButtonList key;
