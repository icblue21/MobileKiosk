...
public class Order_Hojupmong extends AppCompatActivity implements View.OnClickListener, BusProvider.OntimeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_hojupmong);
    ...
    public void ontimePickerset(String name, int price) {
        ...
        ML.addLast(new MenuData(name, price,1));
    ...
    public void InitializeView()
    {
        ...
        HojupmongFragment1 fragment1 = new HojupmongFragment1();
    ...
    private void callFragment(int frament_no){
        ...
        switch (frament_no){
            ...
            case 2:
                // '프래그먼트2' 호출
                HojupmongFragment2 fragment2 = new HojupmongFragment2();
                transaction.replace(R.id.fragframe, fragment2);
                transaction.commit();
                break;
            case 3:
                // '프래그먼트2' 호출
                HojupmongFragment3 fragment3 = new HojupmongFragment3();
                transaction.replace(R.id.fragframe, fragment3);
                transaction.commit();
                break;
            case 4:
                // '프래그먼트2' 호출
                HojupmongFragment4 fragment4 = new HojupmongFragment4();
    ...
    public void addlist(String name, int price){
        ...
        //queue.en//queue(tvProdc.getText().toString(),num,tvPrice.getText().toString());
