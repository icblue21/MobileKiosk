...
public class JongroFragment4 extends Fragment {
    int resId;
    ImageButton button[];
    Button btn[];
    TextView text[];
    JongroFragment4.ButtonList BList[];

    private BusProvider.OntimeListener ontime;

    public JongroFragment4() {
        // required
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.fragment_jongro4, container, false);
        ...
        BList[0] = new JongroFragment4.ButtonList(R.drawable.mak1, "장수막걸리", 3000);
        BList[1] = new JongroFragment4.ButtonList(R.drawable.mak2, "이동막걸리", 3000);
        BList[2] = new JongroFragment4.ButtonList(R.drawable.mak3, "밤막걸리", 4000);
        BList[3] = new JongroFragment4.ButtonList(R.drawable.mak4, "배다리막걸리", 4000);
        BList[4] = new JongroFragment4.ButtonList(R.drawable.drink1, "탄산음료", 1000);
    ...
    void SubListenner(int num) {
        switch (num) {
            ...
            case 4:
                ...
                ((Order_Jongro)getActivity()).setResultView(BList[4].price);
                break;
        }
    }
    ...
    void insertion_sort_price(JongroFragment4.ButtonList list[], int n) {
        int i, j;
        JongroFragment4.ButtonList key;
    ...
    void insertion_sort_name(JongroFragment4.ButtonList list[], int n) {
        int i, j;
        JongroFragment4.ButtonList key;
