...
public class Order_Jongro extends AppCompatActivity implements View.OnClickListener, BusProvider.OntimeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_jongro);
    ...
    public void InitializeView()
    {
        ...
        JongroFragment1 fragment1 = new JongroFragment1();
    ...
    private void callFragment(int frament_no){
        ...
        switch (frament_no){
            ...
            case 2:
                // '프래그먼트2' 호출
                JongroFragment2 fragment2 = new JongroFragment2();
                transaction.replace(R.id.fragframe, fragment2);
                transaction.commit();
                break;
            case 3:
                // '프래그먼트2' 호출
                JongroFragment3 fragment3 = new JongroFragment3();
                transaction.replace(R.id.fragframe, fragment3);
                transaction.commit();
                break;
            case 4:
                // '프래그먼트2' 호출
                JongroFragment4 fragment4 = new JongroFragment4();
