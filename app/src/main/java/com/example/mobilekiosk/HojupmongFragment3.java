...
public class HojupmongFragment3 extends Fragment {
    int resId;
    ImageButton button[];
    Button btn[];
    TextView text[];
    HojupmongFragment3.ButtonList BList[];

    private BusProvider.OntimeListener ontime;

    public HojupmongFragment3() {
        // required
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.fragment_hojupmong3, container, false);
        ...
        BList = new ButtonList[4];
        BList[0] = new HojupmongFragment3.ButtonList(R.drawable.half1, "짬짜면", 5500);
        BList[1] = new HojupmongFragment3.ButtonList(R.drawable.half2, "볶짜면", 6000);
        BList[2] = new HojupmongFragment3.ButtonList(R.drawable.half3, "탕짜면", 6500);
        BList[3] = new HojupmongFragment3.ButtonList(R.drawable.half4, "탕짬면", 7000);
    ...
    void insertion_sort_price(HojupmongFragment3.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment3.ButtonList key;
    ...
    void insertion_sort_name(HojupmongFragment3.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment3.ButtonList key;
