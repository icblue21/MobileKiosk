...
public class HojupmongFragment2 extends Fragment {
    int resId;
    ImageButton button[];
    Button btn[];
    TextView text[];
    HojupmongFragment2.ButtonList BList[];

    private BusProvider.OntimeListener ontime;

    public HojupmongFragment2() {
        // required
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.fragment_hojupmong2, container, false);
        ...
        BList[0] = new HojupmongFragment2.ButtonList(R.drawable.cook1, "탕수육", 10000);
        BList[1] = new HojupmongFragment2.ButtonList(R.drawable.cook2, "깐풍기", 12000);
        BList[2] = new HojupmongFragment2.ButtonList(R.drawable.cook3, "유산슬", 15000);
        BList[3] = new HojupmongFragment2.ButtonList(R.drawable.cook4, "양장피", 13000);
        BList[4] = new HojupmongFragment2.ButtonList(R.drawable.cook5, "군만두", 5000);
    ...
    void insertion_sort_price(HojupmongFragment2.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment2.ButtonList key;
    ...
    void insertion_sort_name(HojupmongFragment2.ButtonList list[], int n) {
        int i, j;
        HojupmongFragment2.ButtonList key;
