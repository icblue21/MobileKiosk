...
public class JongroFragment3 extends Fragment {
    int resId;
    ImageButton button[];
    Button btn[];
    TextView text[];
    JongroFragment3.ButtonList BList[];

    private BusProvider.OntimeListener ontime;

    public JongroFragment3() {
        // required
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.fragment_jongro3, container, false);
        ...
        BList[0] = new JongroFragment3.ButtonList(R.drawable.else1, "모둠전", 8000);
        BList[1] = new JongroFragment3.ButtonList(R.drawable.else2, "도토리묵", 8500);
        BList[2] = new JongroFragment3.ButtonList(R.drawable.else3, "골뱅이무침", 9000);
        BList[3] = new JongroFragment3.ButtonList(R.drawable.else4, "깐녹두", 10000);
    ...
    void insertion_sort_price(JongroFragment3.ButtonList list[], int n) {
        int i, j;
        JongroFragment3.ButtonList key;
    ...
    void insertion_sort_name(JongroFragment3.ButtonList list[], int n) {
        int i, j;
        JongroFragment3.ButtonList key;
